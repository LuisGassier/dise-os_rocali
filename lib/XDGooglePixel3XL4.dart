...
class XDGooglePixel3XL4 extends StatelessWidget {
  XDGooglePixel3XL4({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(195.0, 755.0),
            child:
                // Adobe XD layer: 'upload' (shape)
                PageLink(
              links: [
                PageLinkInfo(
                        ...
                        children: <Widget>[
                          SizedBox(
                            ...
                            child: Stack(
                              children: <Widget>[
                                Pinned.fromSize(
                                  bounds: Rect.fromLTWH(0.0, 14.0, 67.0, 48.0),
                                  size: Size(67.0, 62.0),
                                  child: Container(
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(25.0),
                                ...
                                Pinned.fromSize(
                                  bounds: Rect.fromLTWH(21.0, 0.0, 42.0, 38.0),
                                  size: Size(67.0, 62.0),
                                  child:
                                      // Adobe XD layer: '26-Set-Ban_ao-Circu…' (shape)
                                      Container(
                                ...
                                Pinned.fromSize(
                                  bounds: Rect.fromLTWH(10.0, 38.0, 20.0, 7.0),
                                  size: Size(67.0, 62.0),
                                  child: Text(
                                    'Juego de baño\nMarmol',
                                    style: TextStyle(
                                ...
                                Pinned.fromSize(
                                  bounds: Rect.fromLTWH(23.0, 53.0, 11.0, 3.0),
                                  size: Size(67.0, 62.0),
                                  child: Text(
                                    '\$325.00',
                                    style: TextStyle(
                            ...
                            child: SizedBox(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Pinned.fromSize(
                                    bounds:
                                        Rect.fromLTWH(29.0, 2.0, 10.0, 17.0),
                                    size: Size(68.0, 21.0),
                                    child: Text(
                                      '2',
                                      style: TextStyle(
                                  ...
                                  Pinned.fromSize(
                                    bounds: Rect.fromLTWH(1.0, 1.0, 19.0, 19.0),
                                    size: Size(68.0, 21.0),
                                    child: ClipOval(
                                      child: BackdropFilter(
                                        filter: ui.ImageFilter.blur(
                                  ...
                                  Pinned.fromSize(
                                    bounds:
                                        Rect.fromLTWH(48.0, 1.0, 19.0, 19.0),
                                    size: Size(68.0, 21.0),
                                    child: ClipOval(
                                      child: BackdropFilter(
                                        filter: ui.ImageFilter.blur(
                                  ...
                                  Pinned.fromSize(
                                    bounds: Rect.fromLTWH(3.0, 3.0, 15.0, 15.0),
                                    size: Size(68.0, 21.0),
                                    child:
                                  ...
                                  Pinned.fromSize(
                                    bounds:
                                        Rect.fromLTWH(50.0, 3.0, 15.0, 15.0),
                                    size: Size(68.0, 21.0),
                                    child:
...
const String _svg_f3vv2c =
    '<svg viewBox="0.0 0.0 412.0 847.0" ><defs><linearGradient id="gradient" x1="0.5" y1="0.0" x2="0.5" y2="1.0"><stop offset="0.0" stop-color="#fff2e3ce"  /><stop offset="1.0" stop-color="#ffbd9968"  /></linearGradient></defs><path  d="M 0 0 L 412 0 L 412 847 L 0 847 L 0 0 Z" fill="url(#gradient)" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_57wqo2 =
    '<svg viewBox="0.0 750.0 413.0 97.0" ><path transform="translate(599.0, 1703.0)" d="M -599.0004272460938 -855.9999389648438 L -599.0004272460938 -858.9681396484375 C -599.0004272460938 -897.0750122070313 -568.10791015625 -927.967529296875 -530.0001220703125 -927.967529296875 L -411.2066040039063 -927.967529296875 C -408.0326843261719 -942.3076782226563 -395.7127990722656 -953.0001220703125 -380.9996948242188 -953.0001220703125 C -366.28662109375 -953.0001220703125 -353.9673767089844 -942.3076782226563 -350.7936401367188 -927.967529296875 L -186.0003051757813 -927.967529296875 L -186.0003051757813 -855.9999389648438 L -599.0004272460938 -855.9999389648438 Z" fill="#ff8000" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_8ybwpl =
    '<svg viewBox="195.0 755.0 42.0 21.0" ><defs><pattern id="image" patternUnits="userSpaceOnUse" width="512.0" height="512.0"><image xlink:href="null" x="0" y="0" width="512.0" height="512.0" /></pattern></defs><path transform="translate(195.0, 755.0)" d="M 21 0 L 42 21 L 0 21 Z" fill="url(#image)" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
